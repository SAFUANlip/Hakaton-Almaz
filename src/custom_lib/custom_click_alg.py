...
__all__ = [
    ...
    "node_clique_number",
    "number_of_cliques",
    "custom_enumerate_all_cliques",
    "custom_max_weight_clique",
]


@not_implemented_for("directed")
#@nx._dispatchable
def custom_enumerate_all_cliques(G):
    ...
    def update_incumbent_if_improved(self, C, C_weight):
        ...
        if C_weight > self.incumbent_weight:
            ...
            if len(self.top5cliques.keys()) < 5:
                self.top5cliques[self.incumbent_weight] = self.incumbent_nodes
            elif min(self.top5cliques.keys()) < self.incumbent_weight:
